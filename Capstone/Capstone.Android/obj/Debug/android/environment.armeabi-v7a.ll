...
@__app_environment_variables_v_2.5 = internal constant [37 x i8] c"737eecdd-05c3-488a-9884-fb574620a11c\00", align 1
...
@__ApplicationConfig_android_package_name.0 = internal constant [25 x i8] c"com.companyname.capstone\00", align 1
...
@__DSOCacheEntry_name.5 = internal constant [18 x i8] c"libe_sqlcipher.so\00", align 1
...
@dso_cache = local_unnamed_addr global [32 x %struct.DSOCacheEntry] [
	...
	; 4
	%struct.DSOCacheEntry {
		i64 653067277, ; hash 0x26ed040d, from name: e_sqlcipher
		i8 0, ; ignore
	...
	; 13
	%struct.DSOCacheEntry {
		i64 2157665675, ; hash 0x809b5d8b, from name: e_sqlcipher.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([18 x i8], [18 x i8]* @__DSOCacheEntry_name.5, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 17
	%struct.DSOCacheEntry {
		i64 2534955830, ; hash 0x97185b36, from name: libe_sqlcipher
		i8 0, ; ignore
		i8* getelementptr inbounds ([18 x i8], [18 x i8]* @__DSOCacheEntry_name.5, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 24
	%struct.DSOCacheEntry {
		i64 3518682523, ; hash 0xd1bad59b, from name: libe_sqlcipher.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([18 x i8], [18 x i8]* @__DSOCacheEntry_name.5, i32 0, i32 0), ; name
		i8* null; handle
	}, 
